...
public class MessageQueueFlatFile implements messageQueueInterface{
    ...
    // where we store our messages of progress
    private LogMessage LogResult = new LogMessage();
   ...
   /** Delete a message using the ID field */
    public Boolean delete(String messageID) {
        container.delete(msg.FIELD_ID, messageID);
        return true;
    }
    ...
    private void log(int gender, String message, String... args) {
        // log this occurence
        LogResult.add(title, gender, message, args);
    }
